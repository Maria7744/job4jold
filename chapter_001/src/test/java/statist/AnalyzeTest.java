...
public class AnalyzeTest {
    ...
    @Test
    public void whenAllNewAdd() {
        List<Analyze.User> userList = new ArrayList<>();
        List<Analyze.User> newUserList = new ArrayList<>();
        newUserList.add(new Analyze.User(1, "f"));
        newUserList.add(new Analyze.User(2, "s"));
        newUserList.add(new Analyze.User(3, "t"));
        Analyze analyze = new Analyze();
    ...
    public void whenNoChanges() {
        List<Analyze.User> userList = new ArrayList<>();
        userList.add(new Analyze.User(1, "f"));
        List<Analyze.User> newUserList = new ArrayList<>();
        newUserList.add(new Analyze.User(1, "f"));
        Analyze analyze = new Analyze();
